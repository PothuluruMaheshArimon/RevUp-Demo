        ...
        (t = function () {
            var r = {
                ...
                startTimer: function (e, t) {
                    ...
                    r.startStopTimes[e].push({ startTime: t || new Date(), stopTime: void 0 }), (r.active = !0);
                },
                ...
                setIdleDurationInSeconds: function (e) {
                    var t = parseFloat(e);
                    if (!1 !== isNaN(t)) throw { name: "InvalidDurationException", message: "An invalid duration time (" + e + ") was provided." };
                ...
                checkState: function () {
                    for (var e = 0; e < r.timeElapsedCallbacks.length; e++)
                        r.timeElapsedCallbacks[e].pending && r.getTimeOnCurrentPageInSeconds() > r.timeElapsedCallbacks[e].timeInSeconds && (r.timeElapsedCallbacks[e].callback(), (r.timeElapsedCallbacks[e].pending = !1));
                ...
                listenForVisibilityEvents: function () {
                    void 0 !== document.hidden
                        ? ((r.hiddenPropName = "hidden"), (r.visibilityChangeEventName = "visibilitychange"))
                        : void 0 !== document.mozHidden
                        ? ((r.hiddenPropName = "mozHidden"), (r.visibilityChangeEventName = "mozvisibilitychange"))
                        : void 0 !== document.msHidden
                        ? ((r.hiddenPropName = "msHidden"), (r.visibilityChangeEventName = "msvisibilitychange"))
                        : void 0 !== document.webkitHidden && ((r.hiddenPropName = "webkitHidden"), (r.visibilityChangeEventName = "webkitvisibilitychange")),
                ...
                sendCurrentTime: function (e) {
                    var t = { type: "INSERT_TIME", appId: e, timeOnPageMs: r.getTimeOnCurrentPageInMilliseconds(), pageName: r.currentPageName };
                    r.websocketSend(t);
                },
                ...
                initialize: function (e) {
                    var t = r.idleTimeoutMs || 30,
                        ...
                        i = void 0,
                        s = void 0;
                    e && ((t = e.idleTimeoutInSeconds || t), (n = e.currentPageName || n), (i = e.websocketOptions), (s = e.initialStartTime)),
                        r.setIdleDurationInSeconds(t).setCurrentPageName(n).setUpWebsocket(i).listenForVisibilityEvents(),
